...
void Presenter_Accessory_Init(UI_Presenter_Base_t *self) {
  ...
  // Color_ID saved_headlight_color_id;
  ...
  Model_Accessory_Set_Btn_Color_Headlights(presenter->model, COLOR_NONE);
  Model_Accessory_Set_Btn_Color_Bodylights(presenter->model, COLOR_NONE);
}